...
export default function IndexPage() {
  return (
    <div className="bg-gray-200 ">
      ...
      <div className="container mx-auto px-1 pt-16 w-screen">
        <div className="  md:flex items-center mb ">
          <div className=" w-full md:w-1/2 ">
            <div className="px-6 py-8 shadow rounded-3xl max-w-2xl space-y-16 space-between">
              ...
              <p className=" mt-2 text- text-gray-600 dark:text-gray-400 pr-8 opacity-50 hover:opacity-100">
          ...
          <div className="flex items-center justify-center w-full mt-6 md:mt-0 md:w-1/2 sm:w-1/2">
            <img
              className=" max-w-xl w-full h-full rounded-3xl shadow"
              src="/catalogo.jpg"
              alt="weights"
            />
          </div>
